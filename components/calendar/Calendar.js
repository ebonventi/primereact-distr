...
var Calendar = exports.Calendar = function (_Component) {
    ...
    _createClass(Calendar, [{
        ...
        value: function shouldComponentUpdate(nextProps, nextState) {
            return nextProps.value !== this.props.value || this.state.currentMonth !== nextState.currentMonth || this.state.currentYear !== nextState.currentYear || this.props.minDate !== nextProps.minDate || this.props.maxDate !== nextProps.maxDate;
        }
    }, {
