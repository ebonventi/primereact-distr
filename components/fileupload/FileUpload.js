    ...
    _createClass(FileUpload, [{
        ...
        value: function render() {
            ...
            if (this.props.mode === 'advanced') {
                ...
                var chooseButtonClassName = (0, _classnames2.default)('ui-fileupload-choose ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left');
                var chooseButton = _react2.default.createElement(
                    'span',
                    { icon: 'fa-plus', className: chooseButtonClassName },
                    ...
                    _react2.default.createElement('span', { className: 'ui-button-icon-left ui-clickable fa fa-fw fa-plus' }),
                ...
                if (this.hasFiles()) {
                    filesList = _react2.default.createElement(
                        ...
                        this.state.files.map(function (file, index) {
                            var preview = _this4.isImage(file) ? _react2.default.createElement(
                                'div',
                                null,
                                _react2.default.createElement('img', { alt: file.name, role: 'presentation', src: file.objectURL, width: _this4.props.previewWidth })
                            ) : null;
