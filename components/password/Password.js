...
var Password = exports.Password = function (_Component) {
    ...
    _createClass(Password, [{
        ...
        value: function onFocus(e) {
            var zIndex = _DomHandler2.default.getZindex();
            this.panel.style.zIndex = String(++zIndex);
            _DomHandler2.default.removeClass(this.panel, 'ui-helper-hidden');
        ...
        value: function onBlur(e) {
            _DomHandler2.default.addClass(this.panel, 'ui-helper-hidden');
        }
    }, {
        key: 'onKeyup',
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_InputText.InputText, { id: this.props.id, ref: function ref(el) {
                ...
                }, type: 'password', onChange: this.props.onChange, onFocus: this.onFocus, onBlur: this.onBlur, onKeyUp: this.onKeyup });
        }
    }]);
