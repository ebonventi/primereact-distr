...
var HeaderCell = exports.HeaderCell = function (_Component) {
    ...
    _createClass(HeaderCell, [{
        ...
        value: function render() {
            ...
            var sortOrder = 0;
            var resizer = this.props.resizableColumns && _react2.default.createElement('span', { className: 'ui-column-resizer ui-clickable', onMouseDown: this.onMouseDown });
            ...
            if (this.props.filter) {
                filterElement = this.props.filterElement || _react2.default.createElement(_InputText.InputText, { onInput: this.onFilterInput, type: this.props.filterType,
