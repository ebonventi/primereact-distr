...
var DataTable = exports.DataTable = function (_Component) {
    ...
    _createClass(DataTable, [{
        ...
        value: function onSort(event) {
            var sortOrder = this.state.sortField === event.sortField ? this.state.sortOrder === 1 ? -1 : 0 : 1;
            var sortField = sortOrder !== 0 ? event.sortField : null;
        ...
        key: 'removeSortMeta',
        value: function removeSortMeta(field, multiSortMeta) {
            return multiSortMeta.filter(function (x) {
        ...
        value: function onFilter(event) {
            ...
            if (!this.isFilterBlank(event.value)) {
                ...
                var column = columns.filter(function (x) {
        ...
        value: function onColumnResizeEnd(event) {
            ...
            if (columnWidth + delta > parseInt(minWidth, 10)) {
                if (this.props.columnResizeMode === 'fit') {
                    ...
                    this.resizeColumn.style.width = newColumnWidth + 'px';
                    var containerWidth = this.table.style.width;
        ...
        value: function createTableBody(value, columns) {
            return _react2.default.createElement(
                ...
                { value: value, first: this.state.first, rows: this.state.rows, lazy: this.props.lazy,
